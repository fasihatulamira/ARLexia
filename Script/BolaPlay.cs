...
public class BolaPlay : MonoBehaviour
{
    ...
    public GameObject videoOverlay; // Reference to the overlay Image component
    ...
    private Belajar belajarInstance; // Instance of the Belajar class

    void Start()
    {
        // Create an instance of the Belajar class
        belajarInstance = FindObjectOfType<Belajar>();
        if (belajarInstance == null)
        {
            Debug.LogError("Belajar instance not found in the scene.");
        }
        ...
        if (videoOverlay != null)
        {
            ...
            videoOverlay.gameObject.SetActive(false); // Initially disable the overlay
        }
        else
        {
    ...
    public void PlayVideo()
    {
        if (videoPlayer != null && isVideoPrepared)
        {
            ...
            // Enable the video overlay when video starts playing
            if (videoOverlay != null)
            {
    ...
    public void StopVideo()
    {
        if (videoPlayer != null && isVideoPlaying)
        {
            ...
            // Disable the video overlay when video stops
            if (videoOverlay != null)
            {
    ...
    public void ToggleVideoPlayback()
    {
        if (videoPlayer != null && isVideoPrepared)
        {
            ...
            // Ensure the video overlay remains active when the video is paused
            if (videoOverlay != null)
            {
                videoOverlay.gameObject.SetActive(true);
            }
    ...
    private void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
    {
        foreach (var trackedImage in eventArgs.added)
        {
            ...
            if (belajarInstance != null)
            {
                belajarInstance.OnImageTargetDetected(trackedImage.referenceImage.name);
            }
        }
